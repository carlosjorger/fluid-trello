...
<template>
    <div class="rounded-lg shadow p-3 bg-slate-300/40 text-left relative min-h-12" v-on:mouseenter="cardEnter"  v-on:mouseleave="cardLeave" v-click-outside="closeDropdown">
